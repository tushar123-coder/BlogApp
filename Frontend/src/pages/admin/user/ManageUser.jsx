 ...
 const handleCloseModel=()=>
 {
  ...
  return (
    ...
    {isLoading&& <div>Loading...</div>}
                 ...
                 <tr key={index}>
                   ...
                   <td className="border-t-0 px-6 align-center border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                    <span className={`rounded-full py-[2px] px-3 ${
                      user?.role==='admin'?" bg-indigo-500 text-white":"bg-amber-400"
                    }`}>
                    {user?.role}
                    </span>
                   </td>
                   <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                    ...
                    className='flex gap-1 items-center justify-center'><MdModeEdit/> Edit
                    </button>
                   </td>
                   <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                    <button 
     ...
     {
      isModalOpen && <Updateusermodel user={selectedUser}  onClose={handleCloseModel} onRoleUpdate={refetch}/>
     }
   </>
  )
}
